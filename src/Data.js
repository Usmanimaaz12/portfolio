export const EXPERIENCE_DATA = [
  {
    ...
    techStack:
      "React.js, Next.js, TypeScript, Redux Toolkit, Tanstack Query, Tailwind CSS, Supabase",
    description:
      "As a Software Engineer at Squareboat, I optimized an existing website’s performance by addressing Cumulative Layout Shift (CLS) and Largest Contentful Paint (LCP) issues, utilizing Partytown to offload third-party scripts, resulting in a 92% improvement in Google Lighthouse performance score (from 41 to 79). Architected and delivered 4+ scalable admin panels using React.js, TypeScript, and Redux Toolkit, streamlining internal workflows. Developed a high-performance website with Next.js and Tanstack Query for optimized server-state management. Integrated enterprise-grade security features like Role-Based Access Control (RBAC) and Google reCAPTCHA v3, and built a Shopify public app with Supabase for secure token storage.",
  },
  {
    id: 2,
    projectName: "Trading With Vivek",
    projectUrl: "https://tradingwithvivek.com/",
    techStack: "Next.js, Razorpay, Tailwind CSS",
    description:
