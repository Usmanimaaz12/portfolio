      ...
      <div className="flex flex-col md:flex-row gap-12 md:min-h-[73vh] min-h-[70vh] justify-center md:justify-around items-center md:px-4 md:p-2">
        ...
        <div className="flex flex-col items-start md:gap-2 gap-3 md:w-1/2 w-10/12 md:p-0 text-center z-30">
          ...
          <div className="mt-4 md:text-balance md:text-start text-center">
            Hello, I&apos;m Maaz Usmani, a passionate Software Engineer with
            expertise in full-stack development. I specialize in building
            high-performance, scalable web applications using modern
            technologies like Next.js, React, and TypeScript, while prioritizing
            security, optimization, and seamless user experiences. Let's work
            together to craft innovative and impactful digital solutions.
