        ...
        <div className="flex md:gap-12 gap-2 md:justify-between font-medium md:flex-row xl:flex flex-col md:m-0 mt-8">
            ...
            <i
              onClick={() => {
                window.location.href =
                  "mailto:usmanimaaaz12@gmail.com?body=Hii%20Maaz";
              }}
          ...
          <div className="flex md:flex-col xl:flex-row gap-6 items-center md:my-10">
            <div
              ...
              onClick={() => {
                window.location.href =
                  "https://api.whatsapp.com/send/?phone=6307098514&text=Hey%21+I+want+to+discuss+a+project+with+you&type=phone_number&app_absent=0";
              }}
            >
              <Icon
